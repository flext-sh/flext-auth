...
2. `src/flext_auth/__init__.py` exports
3. Module docstrings
...
- Primary facades: `FlextAuth`, `FlextAuthApiKeyProvider`, `FlextAuthApplicationService`, `FlextAuthBasicProvider`, `FlextAuthCertificateProvider`, `FlextAuthConstants` (+24 more)
