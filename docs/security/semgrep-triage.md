...
| 5 | medium | low | `httpsconnection-detected` | `src/flext_auth/providers/oauth2_introspection.py` | 93 | |
...
Dados brutos: `~/semgrep-violations/by-repo/flext-sh__flext-auth.json`
