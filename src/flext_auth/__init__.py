...
if TYPE_CHECKING:
    ...
    from ._config import FlextAuthConfig as FlextAuthConfig
    from ._config import config as config
    from ._settings import FlextAuthSettings as FlextAuthSettings
    from ._settings import settings as settings
    from .api import FlextAuth as FlextAuth
