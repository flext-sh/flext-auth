...
class HttpTransportAdapter:
    ...
    def post_token_request(
        ...
        try:
            ...
            return FlextResult[dict[str, object]].fail(f"Token request HTTP error: {e}")
        except Exception as e:
            return FlextResult[dict[str, object]].fail(
