...
class FlextAuthDebugIssuesExample:
    """Single owner for auth debug flows."""
    ...
    def main(cls) -> None:
        ...
        cls.debug_password_operations()
        cls.debug_jwt_operations()
        cls.debug_authentication_workflow()


if __name__ == "__main__":
    FlextAuthDebugIssuesExample.main()
